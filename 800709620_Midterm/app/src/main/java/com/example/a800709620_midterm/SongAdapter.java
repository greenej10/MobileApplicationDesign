...
//        this.progressValue = progressValue;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.textViewItemPrice.setText("Album: "+song.albumName+" ");
        String date = song.updatedTime.toString();
...
//        int progressValue;
        ...
        public ViewHolder(@NonNull final View itemView) {
            ...
            textViewItemPrice = itemView.findViewById(R.id.textViewItemAlbum);
